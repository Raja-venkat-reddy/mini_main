...
# Define Model Path
MODEL_PATH = "best_hcec_hybrid_model_best.pth"
...
def predict():
    try:
        ...
        temp_path = os.path.join("/tmp/uploads", filename)  # Render provides /tmp
        ...
        with torch.no_grad():
            ...
            classification = classify_prediction(denorm_output[0], denorm_output[2], denorm_output[1])
